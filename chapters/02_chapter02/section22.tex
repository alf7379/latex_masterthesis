...
% AP
% TODO https://kharshit.github.io/blog/2019/09/20/evaluation-metrics-for-object-detection-and-segmentation
...
The \gls{fcn} introduced by Long in \cite{LSD15-FCN}, is based on the encoder-decoder-architecture with a relatively small decoder.
...
\end{itemize}
% TODO mention and cite DeepLabv3+


% TODO briefly introduce DeepSnakes ?? as semantic segmentation architecture (not interactive) \cite{Pen20_DeepSnake}
...
\end{table}
\footnotetext{Segmentation Results: Leaderboard Pascal VOC 2012: \url{http://host.robots.ox.ac.uk:8080/leaderboard/displaylb_main.php?challengeid=11&compid=6}}
