...
Second, the PASCAL \gls{voc} datasets have so-called \glsentryfull{vp}, that are located around each object as a boundary, as illustrated in Figure \ref{fig:ch2:sec2:segmentation_image}.
